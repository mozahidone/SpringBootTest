...
import com.teksoi.restapi.dto.response.ErrorResponseDto;
import com.teksoi.restapi.dto.response.Response;
...
public final class Utils {
	...
	public static  List<ErrorResponseDto> getCustomError(BindingResult result){
		List<ErrorResponseDto> errors = new ArrayList<ErrorResponseDto>();
	...
	public static Response getFailResponse(BindingResult bindingResults, String message){
		return Response.builder()
				...
				.message(message)
				.errors(Utils.getCustomError(bindingResults))
